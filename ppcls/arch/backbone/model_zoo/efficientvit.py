...
class DSConv(nn.Layer):
    def __init__(
        ...
        norm_layer: Union[Type[nn.Layer], Tuple[Optional[Type[nn.Layer]], ...]] = nn.BatchNorm2D,
        act_layer: Union[Type[nn.Layer], Tuple[Optional[Type[nn.Layer]], ...]] = (nn.ReLU6, None),
    ):
        super().__init__()
...
class MBConv(nn.Layer):
    def __init__(
        ...
        norm_layer: Union[Type[nn.Layer], Tuple[Optional[Type[nn.Layer]], ...]] = nn.BatchNorm2D,
        act_layer: Union[Type[nn.Layer], Tuple[Optional[Type[nn.Layer]], ...]] = (nn.ReLU6, nn.ReLU6, None),
    ):
        super().__init__()
...
class LiteMLA(nn.Layer):
    def __init__(
        ...
        dim: int = 8,
        use_bias: Union[bool, Tuple[bool, ...]] = False,
        norm_layer: Union[Type[nn.Layer], Tuple[Optional[Type[nn.Layer]], ...]] = (None, nn.BatchNorm2D),
        act_layer: Union[Type[nn.Layer], Tuple[Optional[Type[nn.Layer]], ...]] = (None, None),
    ...
    def forward(self, x):
        ...
        HW = H * W
        multi_scale_qkv = paddle.reshape(multi_scale_qkv, [B, num_heads, 3 * self.dim, HW])
...
class ClassifierHead(nn.Layer):
    def __init__(
        ...
        self.classifier = nn.Sequential(
            ...
            nn.Linear(widths[1], num_classes, bias_attr=True) if num_classes > 0 else nn.Identity(),
        )
...
def efficientvit_b0(pretrained=False, use_ssld=False, **kwargs):
    ...
    _load_pretrained(
        pretrained, model, MODEL_URLS["efficientvit_b0"], use_ssld=use_ssld)
    return model
...
def efficientvit_b1(pretrained=False, use_ssld=False, **kwargs):
    ...
    model = EfficientVit(**model_args)
    _load_pretrained(
        pretrained, model, MODEL_URLS["efficientvit_b1"], use_ssld=use_ssld)
    return model
...
def efficientvit_b2(pretrained=False, use_ssld=False, **kwargs):
    ...
    model = EfficientVit(**model_args)
    _load_pretrained(
        pretrained, model, MODEL_URLS["efficientvit_b2"], use_ssld=use_ssld)
    return model
...
def efficientvit_b3(pretrained=False, use_ssld=False, **kwargs):
    ...
    model = EfficientVit(**model_args)
    _load_pretrained(
        pretrained, model, MODEL_URLS["efficientvit_b3"], use_ssld=use_ssld)
    return model
...
def efficientvit_l1(pretrained=False, use_ssld=False, **kwargs):
    ...
    _load_pretrained(
        pretrained, model, MODEL_URLS["efficientvit_l1"], use_ssld=use_ssld)
    return model
...
def efficientvit_l2(pretrained=False, use_ssld=False, **kwargs):
    ...
    model = EfficientVitLarge(**model_args)
    _load_pretrained(
        pretrained, model, MODEL_URLS["efficientvit_l2"], use_ssld=use_ssld)
    return model
...
def efficientvit_l3(pretrained=False, use_ssld=False, **kwargs):
    ...
    model = EfficientVitLarge(**model_args)
    _load_pretrained(
        pretrained, model, MODEL_URLS["efficientvit_l3"], use_ssld=use_ssld)
    return model
